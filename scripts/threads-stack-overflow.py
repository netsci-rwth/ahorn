"""Process the threads-stack-overflow dataset from its original ScHoLP source files."""
...
slug = "threads-stack-overflow"
source_folder_name = "threads-stack-overflow-full"
revision = 1
