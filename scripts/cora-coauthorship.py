"""
Script to process the cora-coauthorship dataset and update the corresponding datasheet.

The Cora coauthorship dataset is a hypergraph where nodes are authors and
