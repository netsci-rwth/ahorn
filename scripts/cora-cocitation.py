"""
Script to process the cora-cocitation dataset and update the corresponding datasheet.

The Cora cocitation dataset is a hypergraph where nodes are scientific papers and
...
# Label names for Cora dataset (standard field names)
label_names = [
    "Case_Based",
    "Genetic_Algorithms",
    "Neural_Networks",
