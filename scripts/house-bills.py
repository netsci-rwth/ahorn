"""
Script to process the house-bills dataset and update the corresponding datasheet.
...
dataset_file = root_dir / "public" / "datasets" / "house-bills.txt"
datasheet_file = root_dir / "src" / "datasets" / "house-bills.mdx"

nodes, hyperedges = tnx.datasets.benson.load_benson_hyperedges(
    root_dir / "data" / "house-bills"
)
