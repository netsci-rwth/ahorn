    ...
    <>
      <div className="mb-4 flex flex-wrap items-start gap-8">
        <input
          ...
          className="block w-64 rounded-md border border-gray-300 bg-white py-1.5 pl-3 pr-3 text-sm placeholder-gray-400 focus:border-blue-500 focus:outline-none focus:ring-1 focus:ring-blue-500"
        />
        <div>
