...
const Footer = () => {
  return (
    <footer className="mt-12 border-t border-slate-200/80 bg-white/40 dark:border-slate-800 dark:bg-slate-950/70">
      <div className="mx-auto max-w-7xl px-4 py-10 sm:px-6 lg:px-8">
        <div className="md:flex md:items-center md:justify-between">
          ...
          <p className="mt-6 text-center text-sm text-slate-600 md:order-1 md:mt-0 md:text-left dark:text-slate-400">
            <Link
              href="/"
