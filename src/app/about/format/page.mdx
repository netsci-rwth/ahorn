...
<h1 className="flex items-center justify-between gap-4">
  ...
  <Badge color="primary">Version 0.2</Badge>
</h1>
...
<Alert type="info">The website always links to the latest revision of a dataset and `ahorn-loader` always loads the latest revision. Older revisions are available on [Zenodo](https://zenodo.org/communities/ahorn/) for download.</Alert>
