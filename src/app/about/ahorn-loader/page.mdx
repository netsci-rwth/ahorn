...
<PageHeader
  eyebrow="About"
  title="ahorn-loader"
  description="Command-line and Python tooling for downloading, reading, and validating datasets from AHORN."
  actions={
    <Button
      as="a"
      href="https://pypi.org/project/ahorn-loader/"
      target="_blank"
      variant="secondary"
    >
      View on PyPI
...
# Download a dataset in a specific format (if multiple formats are available):
ahorn_loader.download_dataset("dataset_name", "target_path", format="hif")
