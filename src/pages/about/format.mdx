...
<div class="not-prose float-right">
  <Badge color="info">Version 0.3</Badge>
</div>
...
<details class="mt-3 rounded border border-black-25 bg-white p-4 dark:border-black-75 dark:bg-black-100">
  <summary class="cursor-pointer select-none">Version 0.3</summary>
  <div>
...
<details class="mt-3 rounded border border-black-25 bg-white p-4 dark:border-black-75 dark:bg-black-100">
  <summary class="cursor-pointer select-none">Version 0.2</summary>
  <div>
